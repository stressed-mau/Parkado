...
          if (parqueo.latitud === 0 && parqueo.longitud === 0) return null;
            ...
            // 1. Definir la fuente de la imagen
...
              // ❗ Eliminamos la prop 'image'. El tamaño será controlado por el componente Image interno.
            >
                {/* 2. Componente Image DENTRO del Marker para forzar el tamaño */}
                <Image
                    source={markerImageSource}
                    style={styles.markerImage} // 👈 Controla el width y height aquí
                    resizeMode="contain"
                />
...
  // 💡 ESTILO NUEVO Y CORRECTO: Aplicado a la imagen interna para forzar el tamaño
  markerImage: {
    width: 40, // Tamaño sugerido. Puedes reducirlo a 30 o 25 si aún es grande.
    height: 40, 
  },
